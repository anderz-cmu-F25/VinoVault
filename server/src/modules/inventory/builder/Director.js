class Director {
  ...
  async editExistingEntry(builder, entryId, changedFields) {
    ...
    if (changedFields.purchaseDate !== undefined) builder.setPurchaseDate(changedFields.purchaseDate);
    if (changedFields.storageLocation !== undefined) builder.setStorageLocation(changedFields.storageLocation);
