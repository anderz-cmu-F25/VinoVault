...
function getPriceRangeText(wine: DiscoveredWine) {
  ...
  return (
    <span style={{ color: '#2A2A2A', fontWeight: 600 }}>
      {formatPrice(wine.salePrice ?? wine.regularPrice)}
    </span>
  )
}
...
export function DiscoverPage() {
  ...
  const fetchWines = useCallback(async () => {
    ...
    try {
      ...
      if (!res.ok)
        throw new Error((json as unknown as { message?: string }).message || 'Failed to load wines')
  ...
  return (
    <main className="max-w-6xl mx-auto px-8 py-16">
      ...
      {isLoading ? (
        ...
        <div className="bg-white text-center py-16 px-6" style={{ borderRadius: '16px' }}>
            ...
            >
              <div className="flex items-start justify-between gap-4 mb-4">
                ...
                {wine.salePrice != null &&
                  ...
                  wine.salePrice < wine.regularPrice && (
                    <span
          ...
          >
            ...
            <div className="px-6 pb-6">
              <div className="mb-5">
                ...
                >
                  Current price:{' '}
                  {formatPrice(wishlistTarget.salePrice ?? wishlistTarget.regularPrice)}
                </p>
              </div>
