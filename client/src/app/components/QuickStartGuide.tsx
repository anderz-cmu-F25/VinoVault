...
const steps = [
  {
    ...
    description:
      'Search and browse wines first when you are deciding what to track, buy, or review.',
  },
  {
    icon: Heart,
    title: 'Watch prices',
    description:
      'Add a wine to your wishlist with a target price so VinoVault can surface price drops.',
  },
  {
    icon: Boxes,
    title: 'Manage your cellar',
    description:
      'Move bottles you own into Cellar to record quantity, storage location, status, and notes.',
  },
  {
    icon: Star,
        ...
        <div className="grid gap-5 py-2">
          ...
          >
            ...
            <p className="text-sm" style={{ fontFamily: "'DM Sans', sans-serif", lineHeight: 1.6 }}>
              Tip: Wishlist is for wines you want to buy later; Cellar is for bottles you already
              own.
            </p>
          </div>
        </div>
